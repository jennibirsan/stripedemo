...
const products = [
  ...
  },
  {
    ...
    price: 4000,
    currency: 'usd',
    attributes: {size: 'Medium Standard', gender: 'Woman'},
  },
  {
    id: 'stormcropped',
    name: 'Cropped Hoodie - Storm',
    price: 4000,
    currency: 'usd',
    attributes: {size: 'Large Standard', gender: 'Woman'},
  },
  {
    id: 'stormcropped',
    name: 'Cropped Hoodie - Storm',
    price: 4000,
    currency: 'usd',
    attributes: {size: 'X-Large Standard', gender: 'Woman'},
  },
  {
    id: 'heatherdustcropped',
    name: 'Cropped Hoodie - Heather Dust',
    price: 4000,
    currency: 'usd',
    attributes: {size: 'Small Standard', gender: 'Woman'},
  },
  ...
  },
  {
    ...
    price: 4000,
    currency: 'usd',
    attributes: {size: 'Small Standard', gender: 'Unisex'},
  },
  {
    id: 'whitecrewneck',
    name: 'Crewneck Sweatshirt - White',
    price: 4000,
    currency: 'usd',
    attributes: {size: 'Medium Standard', gender: 'Unisex'},
  },
  {
    id: 'whitecrewneck',
    name: 'Crewneck Sweatshirt - White',
    price: 4000,
    currency: 'usd',
    attributes: {size: 'Large Standard', gender: 'Unisex'},
  },
  {
    id: 'whitecrewneck',
    name: 'Crewneck Sweatshirt - White',
    price: 4000,
    currency: 'usd',
    attributes: {size: 'X-Large Standard', gender: 'Unisex'},
  },
  {
    id: 'peachcrewneck',
    name: 'Crewneck Sweatshirt - Peach',
    price: 4000,
    currency: 'usd',
    attributes: {size: 'Small Standard', gender: 'Unisex'},
  },
